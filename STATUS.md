...
Updated September 22, 2026 (UTC). [Interactive progress report](docs/progress.html) · [Continue on another computer](docs/CONTINUING-WORK.md) · [Deep Testing walkthrough](docs/deep-testing.html).
...
| Community server | The main-panel Add Slide palette, group-consistent typography, alignment controls, saved song layouts, pre-sermon reading template and quote layout are deployed alongside existing workflows. [Walkthrough and checks](docs/verification/2026-09-22-slide-authoring.md). |
...
| --- | --- |
| Heritage / Community | `6dc0cea00ab08efd00979f6f9005c6f1eb1523e0` |
...
4. **Authorized external content:** establish a supported LSB/NASB passage API whose terms cover the intended retained slide workflow, or obtain an authorized full-edition software source; also obtain permitted exact-edition Russian/Ukrainian recordings. Do not infer recording rights from a text's public-domain status.
...
The service-flow update adds numbered reading parents, sibling songs, automatic/removable blanks, expanded refrain/chorus repeats, reusable Welcome/Closing artwork, named-input translation cues and member-protected Community read-along books. [Verification and physical acceptance limits](docs/verification/2026-09-21-service-flow.md).
