...
```
.heritage/installers/syncshow/1.4.0-preview.29/3ae4f2b688de9346c3c4d755fdef1544055ff03d/ci-34866463241/qa-package-macos-arm64/
```
...
3. Open the new copy and check that About shows `1.4.0-preview.29`.
...
The [integration PR](https://github.com/edydex/SyncShow/pull/7) runs source tests and creates temporary QA packages for Windows x64, Linux x64 and both Mac architectures. Preview 29's [package workflow](https://github.com/edydex/SyncShow/actions/runs/34866463241) passed all four targets. These GitHub artifacts expire after seven days. The Apple Silicon installer is retained locally at the path above; its signature, source correspondence and actual executable launch were independently verified. Earlier retained previews remain in their version folders. This development QA preview is separate from the protected public-release workflow.
