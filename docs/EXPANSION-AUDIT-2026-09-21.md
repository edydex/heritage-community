...
| --- | --- |
| Heritage Bible / Community | Reader release source `5e3bc8e4a2901085648e7fa34bbc4e9547b505db`; Android **1.1.45-preview.1**, code **48**, published in the normal Latest feed with APK, build metadata and checksums. The web reader serves the matching assets. |
...
The [release receipt](verification/2026-09-21-android-1.1.45.json) records the
