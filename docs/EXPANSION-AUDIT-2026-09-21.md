...
| --- | --- |
| Heritage Bible / Community | Reader release source `c70e88ed35ee248d1ba43e150a751fce9ea41ec5`; Android **1.1.44-preview.1**, code **47**, published in the normal Latest feed with APK, build metadata and checksums. The web reader serves the matching assets. |
...
`7edc0764a57a1058262ebc5992af525b42cd6175014d33b2840c47477a673f7e`.
The [release receipt](verification/2026-09-21-android-1.1.44.json) records the
unchanged signer, all 694 bundled web files and eleven native test cases.
The live reader's HTML, entry JavaScript/stylesheet, mapping manifest and
Matthew/Romans/Revelation mapping files were compared with the released build. These checks do not
